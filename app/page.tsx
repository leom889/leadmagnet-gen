...
export default function Home() {
  ...
  return (
    <main className="bg-[#f7f7fa] min-h-screen text-black flex flex-col items-center px-4 py-10 font-sans">
      ...
      // updated <div className="bg-white shadow-lg p-6 rounded-xl w-full max-w-xl"> section
<div className="bg-white shadow-lg p-6 rounded-xl w-full max-w-xl space-y-5">
  ...
  <div>
    ...
    <input
      ...
      className="w-full p-3 border border-gray-300 rounded-md bg-gray-100 mb-4"
    />
